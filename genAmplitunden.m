function [A_i,A_a] = genAmplitunden(R,Phi,Z,B_R,nu_max,kappa_z_max,l,d_kappa_z,r_i,r_a)
%function [A_i,A_a] = genAmplitunden(R,Phi,Z,B_R,nu_max,kappa_z_max,l,d_kappa_z,r_i,r_a)
...
disp('interpolating Points');
[B_R,R,Phi,Z] = interpolation(B_R,R,Phi,Z,r_i,r_a,l);


%% Berechnung
m=0;
disp('starting genarting of Amplitudes');
for kappa_z = 1:kappa_z_max
    for nu = 0:nu_max
        [A_1,A_2,A_3,A_4,e_rcond] = genFourierAmplituden(R,Phi,Z,B_R,nu,kappa_z,l,d_kappa_z);
